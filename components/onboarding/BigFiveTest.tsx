...
const QUESTIONS = [
  ...
  { id:'q3',  trait:'conscientiousness', text:'Я довожу задачи до конца, даже когда они стали скучными или появились более интересные идеи.' },
  { id:'q4',  trait:'conscientiousness', text:'У меня есть чёткая система приоритетов, и я ей следую даже под давлением.' },
  { id:'q5',  trait:'extraversion',      text:'Нетворкинг, питчи и знакомства с новыми людьми дают мне энергию.' },
  { id:'q6',  trait:'extraversion',      text:'Мне легко начать разговор с незнакомым инвестором или потенциальным партнёром.' },
  { id:'q7',  trait:'agreeableness',     text:'В конфликте я сначала стараюсь понять точку зрения другого, а потом отстаиваю свою.' },
  { id:'q8',  trait:'agreeableness',     text:'Мне важно, чтобы ко-фаундер и команда чувствовали себя услышанными.' },
  { id:'q9',  trait:'neuroticism', reverse:true, text:'Неопределённость и риск меня мотивируют, а не парализуют.' },
  { id:'q10', trait:'neuroticism', reverse:true, text:'Когда всё идёт не по плану, я сохраняю ясность мышления и двигаюсь дальше.' },
];
    ...
    <div style={{maxWidth:720,margin:'0 auto',padding:'32px 24px'}}>
      <div style={{marginBottom:28}}>
        <div style={{display:'flex',alignItems:'center',gap:8,marginBottom:10}}>
          ...
          <span style={{fontSize:11,fontWeight:600,color:'#c77dff',letterSpacing:'0.12em',textTransform:'uppercase'}}>Шаг 2 из 3</span>
        </div>
        ...
        <p style={{fontSize:14,color:'#9ca3af',lineHeight:1.6}}>
          10 вопросов. AvatarAgent использует результат чтобы говорить твоим голосом и находить совместимых фаундеров.
        </p>
      </div>
