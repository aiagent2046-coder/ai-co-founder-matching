...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("/mnt/agents/output/syndi-agents/fleet.log", encoding="utf-8"),
    ],
)
...
def _get_profiles(args: argparse.Namespace) -> list[dict]:
    ...
    profiles_path = "/mnt/agents/output/syndi-agents/profiles/all_profiles.json"
...
def _get_credentials(args: argparse.Namespace) -> tuple[str, str, str]:
    ...
    app_url = args.app_url or os.environ.get("APP_URL", "http://localhost:3000")
    return supabase_url, anon_key, app_url
...
async def cmd_full(args: argparse.Namespace) -> None:
    ...
    logger.info(f"MATCHES CREATED: {stats.total_matches}")
...
def cmd_stats(args: argparse.Namespace) -> None:
    ...
    stats_path = "/mnt/agents/output/syndi-agents/profiles/run_stats.json"
...
Examples:
  ...
  python run.py stats
    ...
    full_parser.add_argument("--concurrency", type=int, default=10, help="Max concurrent bots (default: 10)")
